...
import pytest
from main import get_transactions_from_file  # Замените на ваше имя модуля
...
def test_get_transactions_from_file(mock_search_description, mock_filter_by_currency,
                                    mock_sort_by_date, mock_filter_by_state,
                                    mock_get_operation_transaction, mock_input):
    # Вызов функции
